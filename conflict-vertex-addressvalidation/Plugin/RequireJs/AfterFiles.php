 ...
 */
 namespace RefactoredGroup\VertexAddressValidation\Plugin\RequireJs;

class AfterFiles
{
    private const MODULE_NAME = 'RefactoredGroup_Vertex_AddressValidation';
    private const VENDOR_MODULE_NAME = 'Vertex_AddressValidation';
